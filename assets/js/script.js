...
function generatePassword() {
    ...
    uppercaseArray[1]
    //-----------------------------------------------------------------
    var numCharacter = prompt("How long of a password do you want (between 1 and 128 characters?");
    ...
    var characters = confirm("And lastly, any special characters in your password?");
